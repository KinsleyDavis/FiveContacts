...
public class ChecagemLogin_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(montarObjetoUserSemLogar()){
            ...
            Intent intent = new Intent(ChecagemLogin_Activity.this, ListaDeContatos_Activity.class); //montando a intent
            intent.putExtra("usuario",user); // passando o parâmetro
    ...
    private User montarObjetoUser() {
        ...
        //mesmas tags utilizadas na outra Activity
