...
// Importa bibliotecas/packages necessárias a aplicação
...
public class ListaDeContatos_Activity extends AppCompatActivity implements UIEducacionalPermissao.NoticeDialogListener, BottomNavigationView.OnNavigationItemSelectedListener {
    ...
    // Flag de bloqueio da ligação no momento da exclusão
...
// Apagar contato de emergencia
    ...
    // Procedure para exibir caixa de mensagem
    protected void caixaDialogoRemover (final Contato c) {
        ...
        adb.setTitle("Excluir contato cadastrado");
        adb.setMessage("Tem certeza?");
        adb.setPositiveButton("Confirma", dialog);
        adb.setNegativeButton("Cancelar", dialog);
        adb.show();
    }

    // Procedimento para apagar contato de emergência
...
// Testa valor do contato diferente de nulo E se valor igual ao num recebido
...
// Atualiza o usuário e ListView
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (item.getItemId() == R.id.anvPerfil) {
            ...
            Intent intent = new Intent(this, com.example.fivecontacts.ContatosEmergencia.activities.PerfilUsuario_Activity.class);
        ...
        if (item.getItemId() == R.id.anvMudar) {
            ...
            Intent intent = new Intent(this, com.example.fivecontacts.ContatosEmergencia.activities.AlterarContatos_Activity.class);
            intent.putExtra("usuario", user);
